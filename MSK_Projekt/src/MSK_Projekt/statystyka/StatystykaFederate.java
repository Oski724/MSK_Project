package MSK_Projekt.statystyka;
...
public class StatystykaFederate {
	...
	public void runFederate() throws Exception{
		...
		rtiamb.joinFederationExecution( "StatystykaFederate", "StacjaFederation", fedamb );
		...
		try
		{
			rtiamb.destroyFederationExecution( "StacjaFederation" );
	...
	public static void main(String[] args) {
		StatystykaFederate sf = new StatystykaFederate();
